...
ros2 launch ur_moveit_config ur_moveit.launch.py ur_type:=ur5 --ros-args --params-file /home/rvl/ros2_ws/src/grasp_control/config/pick_ik.yaml
...
ros2 service call /qbsofthand_control_node/set_closure \
    qbsofthand_control/srv/SetClosure "{closure: 0.5, duration_sec: 1.0}"
```
